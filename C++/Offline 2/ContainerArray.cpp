...
public:
    ...
    void setItemAt(Container a,int index)
    {
        ...
        if(a.getStoredType()==INTEGER)arrayOfContainers[index].setItem(*(int*)a.getItem());
        else if(a.getStoredType()==INT_ARRAY)arrayOfContainers[index].setItem((int*)a.getItem(),a.getFirstDim());
        else if(a.getStoredType()==INT_MATRIX)arrayOfContainers[index].setItem((int**)a.getItem(),a.getFirstDim(),a.getSecondDim());
    }
    ~ContainerArray(){
